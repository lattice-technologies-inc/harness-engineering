...
Active and completed plans for the project.
...
|------|---------|--------|---------|
| [plan-name](plans/plan-name.md) | 2026-02-13 | In Progress | Brief description |
-->
...
See [docs/plans/complete/](plans/complete/) for fully implemented plans.
